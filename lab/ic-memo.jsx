...
const testCases = {'MEMO-TEST':'Alpha fund · Case A', 'MEMO-TEST-SAME-FUND':'Alpha fund · Case B', 'MEMO-TEST-OTHER-FUND':'Beta fund · Case C'};
const requestedCase = new URLSearchParams(location.search).get('caseId');
const caseId = Object.hasOwn(testCases, requestedCase) ? requestedCase : 'MEMO-TEST';
let session;
