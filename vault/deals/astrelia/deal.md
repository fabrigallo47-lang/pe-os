...
_(coordinator, 2026-07-15 20:23)_
...
- **Blocking the decision** (critical, open — ranked by how much depends on them):
  ...
  3. [[q-astrelia-tech]] — Can they build at the scale the plan assumes? (fan-in 1)
  4. [[q-astrelia-u1-61-2-of-plan-revenue-has-no-named]] — 61.2% of plan revenue has no named counterparty (fan-in 0)
  5. [[q-astrelia-u2-14-units-delivered-against-serial]] — 14 units delivered against serial-production volumes the plan assumes (fan-in 0)
  6. [[q-astrelia-u3-nebulaos-margins-65-80-assumed-vs]] — NebulaOS margins 65–80% assumed vs 17–25% on hardware (fan-in 0)
