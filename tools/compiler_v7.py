...
def _build_model_nodes(inp: DealInputs) -> dict:
    ...
    for nid, label, val, cell in [
        ...
        ("MN-STANDALONE-DOWNSIDE-EXIT-MULTIPLE", "Standalone Downside Exit Multiple", 7.5, "Inputs!C53"),
        ...
        ("MN-STANDALONE-UPSIDE-EXIT-MULTIPLE","Standalone Upside Exit Multiple",10.0,"Inputs!C60"),
        ...
        ("MN-ACQUISITION-BASE-EXIT-MULTIPLE","Acq Base Exit Multiple",9.5,"Inputs!C67"),
        ...
        ("MN-COMBINED-RISK-EXIT-MULT","Combined Risk Exit Multiple",8.0,"Inputs!C74"),
